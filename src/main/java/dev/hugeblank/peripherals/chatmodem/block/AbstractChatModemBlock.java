...
public abstract class AbstractChatModemBlock extends Block implements Waterloggable, BlockEntityProvider,IChatModemBlock {

    public static final DirectionProperty FACING = Properties.FACING;

    public AbstractChatModemBlock(Settings settings) {
        super(settings);
        setDefaultState(calculateDefaultState(getStateManager().getDefaultState()));
    }
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new ChatModemBlockEntity( pos, state);
    }
